            		...
            		try{
            			...
            			// 使用 Statement 執行 SQL 敘述           			
        					...
        					for(String f : fff){
            					...
            					out.println(
            				"<td>"+" 1個月 "+"</td>"+
            				"<td><form method='post' action='ClientData.jsp?del="+f+"/"+i+"'>"+
            				"<button name='delete_cart_btn' class='badge bg-danger' >刪除</button>"+
            			               
            				"<input type='hidden' name='headder' id='headder' value='cart' ></form></td>"+
            				"</tr>");
								}
            					i++;
            				}
...
<th>總計: <% out.print(pricetotal); %>$</th>		
              ...
              if(cartitems.length()>1){
               out.println("                     <form action='checkrule.html' method='post' name='cartform' > "+
