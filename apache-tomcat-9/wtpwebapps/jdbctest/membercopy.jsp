                                ...
                                for(int i = 0;i<orderlist_itemid.size();i++)
                                {
                                	...
                                	while(rsII.next())
                                	{
                                		for(int a =0;a<5;a++){
                                            ...
                                            out.println("<td>"+rsII.getInt("itemidno"+a)+"</td>");
                                            out.println("<td>"+rsII.getInt("i"+a+"count")+"</td>");
                                        ...
                                        out.println("<td>"+orderlist_itemname.get(i)+"</td>");
                                        out.println("<td>"+orderlist_itemcount.get(i)+"</td>");
