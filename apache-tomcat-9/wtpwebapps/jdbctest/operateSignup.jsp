...
<%
	request.setCharacterEncoding("UTF-8");
		...
		String userset = (String)request.getParameter("userset");
		String passwordset = (String)request.getParameter("passwordset1");
		String emailset = (String)request.getParameter("emailset");
		String usernameset = (String)request.getParameter("usernameset");
		String phoneset = (String)request.getParameter("phoneset");
		String addressset = (String)request.getParameter("addressset");
